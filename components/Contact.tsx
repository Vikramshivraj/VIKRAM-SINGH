...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const text = response.text || "Thank you so much! Vicky has received your inquiry and will get back to you shortly.";
  ...
  if (status === 'success') {
    return (
      <section id="contact" className="py-32 px-6 animate-[fadeIn_0.6s_ease-out]">
        <div className="max-w-2xl mx-auto text-center space-y-8 bg-white p-12 rounded-sm border border-black/5 shadow-sm">
    ...
    <section id="contact" className="py-32 px-6">
      <div className="max-w-3xl mx-auto space-y-16">
        <div className="text-center space-y-4">
          ...
          <p className="text-black/60 font-light italic">Have a project in mind or just want to say hello?</p>
        </div>
