...
const Social: React.FC = () => {
  const socials = [
    { 
      name: 'Instagram', 
      url: 'https://www.instagram.com/vickyvibes07/', 
      color: '#E4405F',
