      ...
      <div className="max-w-4xl mx-auto text-center space-y-12">
        ...
        <div className="flex justify-center gap-12">
          {socials.map((social) => (
            ...
            >
              <div className="w-16 h-16 rounded-full border border-black/10 flex items-center justify-center group-hover:bg-[#1C1C1C] group-hover:border-[#1C1C1C] transition-all duration-500 transform group-hover:-translate-y-2">
                <svg 
                  className="w-6 h-6 fill-black group-hover:fill-white transition-colors duration-500" 
                  viewBox="0 0 24 24"
                >
                  <path d={social.icon} />
                </svg>
              </div>
              <span className="text-[10px] uppercase tracking-[0.2em] font-medium text-black/40 group-hover:text-black transition-colors">
                {social.name}
              </span>
            </a>
          ))}
